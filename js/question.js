...
const choices2 = document.querySelector(".choice2");
...
function rederQuestion() {
  ...
  choices1.innerHTML = question.choices[0].text;
  choices2.innerHTML = question.choices[1].text;
...
choices2.addEventListener("click", () => nextQuestion(1));
